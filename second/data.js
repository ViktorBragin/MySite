...
const json = `{
  "goods": [
    ...
    },
    {
      ...
      "name": "Пиджак женский (черный)",
      "description": "Черный женский пиджак от фирмы Victor's Prada.",
      "price": 5200,
    ...
    },
    {
      ...
      "description": "Синяя толстовка от фирмы Victor's Prada.",
      "price": 1500,
    ...
    },
    {
      ...
      "description": "Футболка на бородатом мужике, хочешь быть таким же симпатичным - покупай!",
      "price": 4500,
      "img": "images/featured/4.jpg"
    },
    {
      "id": "27bca31f-aac1-4f91-a309-c262046a3d23",
      "name": "Пиджак женский (голубой)",
